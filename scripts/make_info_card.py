...
ROWS = [
    ("host",),
    ("kv", "Now", "Looking for SDE / AI / ML roles"),

    ("kv", "Edu", "B.Sc.I.T, Mumbai University '25"),
    ("kv", "Edu", "MCA in AI/ML, Amity University '27"),
    
    ("gap",),

    ("kv", "Frontend", "React, Next.js"),
    ("kv", "Backend", "Node, NestJS, GraphQL, Django,Python"),
    ("kv", "AI / ML", "LangChain, OpenAI, PyTorch, TensorFlow"),

    ("gap",),

    ("sec", "Highlights"),
    ("bul", "completed Data science/Deep learning certification course from IIT Guwahati"),
    ("bul", "pursuing google cloud certification course"),
]
